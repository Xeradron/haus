...
export class TodoControllerService {
     ...
     */
    public todoControllerCount(where?: object, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public todoControllerCount(where?: object, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public todoControllerCount(where?: object, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public todoControllerCount(where?: object, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<InlineResponse200>(`${this.configuration.basePath}/todos/count`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public todoControllerFind(filter?: object, observe?: 'body', reportProgress?: boolean): Observable<Array<Todo>>;
    public todoControllerFind(filter?: object, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<Todo>>>;
    public todoControllerFind(filter?: object, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<Todo>>>;
    public todoControllerFind(filter?: object, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public todoControllerUpdateAll(where?: object, todo?: Todo, observe?: 'body', reportProgress?: boolean): Observable<InlineResponse200>;
    public todoControllerUpdateAll(where?: object, todo?: Todo, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<InlineResponse200>>;
    public todoControllerUpdateAll(where?: object, todo?: Todo, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<InlineResponse200>>;
    public todoControllerUpdateAll(where?: object, todo?: Todo, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.patch<InlineResponse200>(`${this.configuration.basePath}/todos`,
            todo,
            {
                params: queryParameters,
                withCredentials: this.configuration.withCredentials,
